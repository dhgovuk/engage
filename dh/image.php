...
?>
	...
	<section id="primary" class="content-area image-attachment section-row">
	...
	?>
			...
			<nav id="image-navigation" class="navigation image-navigation">
				<div class="nav-links">
				<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'dh' ) . '</div>' ); ?>
				<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'dh' ) . '</div>' ); ?>
				</div><!-- .nav-links -->
